...
sudo pacman -S git imlib2 ttf-jetbrains-mono ttf-jetbrains-mono-nerd noto-fonts base-devel github-cli lazygit fzf zoxide starship swayimg xdg-desktop-portal xdg-desktop-portal-gtk --noconfirm
